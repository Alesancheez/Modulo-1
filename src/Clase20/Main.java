...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       // Empleado jose  = new Empleado ("Jose","Lopez",44541214,1100123456,800000.0);
        ...
        //CASTING
        Empleado empleadoGeneral1 =new LimpiezaGeneral("Peter","Parker",14414214,1100012345,800000.0);
        Empleado empleadoGeneral2 =new LimpiezaGeneral("Bruce","Wayne",26521478,1134567890,80000.0);
        Empleado empleadoVajilla1 =new LimpiezaVajilla("Clark","Kent",39658214,1101234567,800000.0);
        ...
        empleadoGeneral1= new LimpiezaVajilla("Peter","Parker",14414214,1100012345,800000.0);
